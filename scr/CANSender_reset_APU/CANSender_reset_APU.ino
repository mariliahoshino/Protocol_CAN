...
void loop() {
  ...
  Serial.println("Enviando reset LVPS-1 ");

  CAN.beginPacket(0x185);  //389 em decimal
  CAN.write(0x00);
  CAN.write(0x00);
  CAN.write(0x00);
  CAN.write(0x00);
  ...
  Serial.println("Enviado reset APU LVPS-1 \n");

  delay(1000);

  Serial.println("Enviando reset LVPS-2");
  ...
  Serial.println("Enviado reset APU LVPS-2 \n");

  delay(1000);
  

  Serial.println("Enviando reset 3O");
  ...
  Serial.println("Enviado reset APU 3O\n");
